...
<form class="formoid-flat-green" action="<%=basePath %>registuser"  style="background-color:#ffffff;font-size:14px;font-family:'Lato', sans-serif;color:#000000;max-width:1200px;min-width:150px" method="post">
	...
	<div style="font-size:16px;">Success to send email! Go Back to <a href="<%=basePath %>es893_9iu8r7e">ESEM Management</a></div>
	<div style="font-size:16px;">
		<%
			String emailcont = (String)request.getAttribute("emailcont");
			if(emailcont != null){
		%>
			<p><%=emailcont %></p>
		<%
